...
export const MOCK_USERS: IUser[] = [
  ...
  { id: '4', name: 'Operator Ghufron 1', email: 'op.ghufron2@example.com', role: 'operator', status: 'inactive', createdAt: '2026-05-17', password: 'password123' },
  { id: '5', name: 'Operator Ghufron 2', email: 'op.ghufron3@example.com', role: 'operator', status: 'active', createdAt: '2026-05-18', password: 'password123' },
  { id: '6', name: 'Admin Ghufron', email: 'adm.ghufron4@example.com', role: 'admin', status: 'inactive', createdAt: '2026-05-19', password: 'password123' }
];